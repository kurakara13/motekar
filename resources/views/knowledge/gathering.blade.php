              ...
              <div class="card">
                <div class="body">
                  ...
                  <table class="table text-center">
                    <tr>
                      <th class="text-success">Summary </th>
                    </tr>
                    <tr>
                      <td>{{$projects->summary->summary}}</td>
                    </tr>
                  </table>
                  <div >
                    <h3 class="text-center">Golden Circle</h3>
                    <div class="row clearfix">
                      <div class="col-lg-6">
                      ...
                      <div class="col-lg-6">
                        <h5>Why</h5>
                        <p>{{$projects->goldencircle->why}}</p>
                        <h5>How</h5>
                        <p>{{$projects->goldencircle->how}}</p>
                        <h5>What</h5>
                        <p>{{$projects->goldencircle->what}}</p>
                        <h5>Unique Value</h5>
                        <p>{{$projects->goldencircle->unique_value}}</p>
                      </div>
                    </div>
                  </div>
