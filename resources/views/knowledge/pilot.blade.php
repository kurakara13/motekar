          ...
          <div class="col-lg-12">
              ...
              <div class="card">
                <div class="body">
                  ...
                  <div class="row clearfix">
                    <div class="col-md-8">
                      <h5 class="text-success">Development Story</h5>
                      <p>{{$projects->pilotproject->development_story}}</p>
                    </div>
                    <div class="col-md-4">
                      <h5 class="text-success">Document</h5>

                      <a href="{{asset('file/doc/'.$projects->pilotproject->doc_file)}}"> <i class="fa fa-file-pdf-o"></i> Dokumentasi Pilot Project File</a><br>
