                ...
                <div class="body">
                  ...
                  <div class="row clearfix">
                    <div class="col-md-8">
                      ...
                      <p>{{$projects->productdevelopment->development_story}}</p>
                    </div>
                    <div class="col-md-4">
                      <h5 class="text-success">Document</h5>
                      <a href="{{asset('file/mockup/'.$projects->productdevelopment->mockup_file)}}"> <i class="fa fa-file-pdf-o"></i> Mockup File</a><br>
                      <a href="{{asset('file/mockup/'.$projects->productdevelopment->doc_file)}}"> <i class="fa fa-file-pdf-o"></i> Dokumentasi File</a><br>
